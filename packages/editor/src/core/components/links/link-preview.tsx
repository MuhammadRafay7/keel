...
import { CopyIcon, GlobeIcon, EditIcon } from "@keel/propel/icons";
// components
...
export function LinkPreview({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-sm border-2 border-subtle bg-layer-1 p-2 text-11 text-tertiary shadow-overlay-100">
