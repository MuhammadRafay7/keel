...
// keel imports
import type { TWorkspaceSettingsItem, TWorkspaceSettingsTabs } from "@keel/types";
...
export const WORKSPACE_SETTINGS: Record<TWorkspaceSettingsTabs, TWorkspaceSettingsItem> = {
  ...
  attendance: {
    key: "attendance",
    i18n_label: "workspace_settings.settings.attendance.title",
    href: `/settings/attendance`,
    access: [EUserWorkspaceRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/settings/attendance/`,
  },
  webhooks: {
    key: "webhooks",
...
export const GROUPED_WORKSPACE_SETTINGS: Record<WORKSPACE_SETTINGS_CATEGORY, TWorkspaceSettingsItem[]> = {
  ...
  [WORKSPACE_SETTINGS_CATEGORY.FEATURES]: [WORKSPACE_SETTINGS["attendance"]],
