...
import { ChevronDownIcon, ChevronRightIcon } from "@keel/propel/icons";
// keel helpers
// helpers
...
function CustomMenu(props: ICustomMenuDropdownProps) {
  ...
  let menuItems = (
    ...
    >
      <div
        className={cn(
          "my-1 min-w-[12rem] overflow-y-scroll rounded-md border border-strong-1 bg-surface-1 px-2 py-2.5 text-11 whitespace-nowrap shadow-overlay-100 ring-1 ring-strong-1/15 outline-none focus:outline-none",
          {
      ...
      {isOpen && (
        <Portal>
          <div
            ...
            {...attributes.popper}
            className={cn(
              "fixed z-30 min-w-[12rem] overflow-hidden rounded-md border border-strong-1 bg-surface-1 p-1 text-11 shadow-overlay-100 ring-1 ring-strong-1/15",
              contentClassName
            )}
...
function SubMenuContent(props: ICustomSubMenuContentProps) {
  ...
  return (
    <div
      className={cn(
        "z-[15] min-w-[12rem] overflow-hidden rounded-md border border-strong-1 bg-surface-1 p-1 text-11 shadow-overlay-100 ring-1 ring-strong-1/15",
        className
      )}
    >
      {children}
