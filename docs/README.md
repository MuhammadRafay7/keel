...
Working documentation for Keel — a project management app being migrated off Django onto Supabase and deployed at `keel.ostenmark.com`.
...
- **Licensing.** AGPL-3.0-only. See [architecture.md](./architecture.md#licensing).
