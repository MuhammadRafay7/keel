...
import { EModalWidth, ModalCore } from "@keel/ui";
...
export const PaidPlanUpgradeModal = observer(function PaidPlanUpgradeModal(props: PaidPlanUpgradeModalProps) {
  ...
  const handleRedirection = ({ planVariant, priceId }: TCheckoutParams) => {
    // Get the product and price using keel community constants
    const product = KEEL_COMMUNITY_PRODUCTS[planVariant];
        ...
        <div className="grid h-full grid-cols-12 gap-6">
          ...
          <div className={cn(COMMON_CARD_CLASSNAME)}>
            <PlanUpgradeCard
              ...
              product={KEEL_COMMUNITY_PRODUCTS[EProductSubscriptionEnum.PRO]}
          ...
          <div className={cn(COMMON_CARD_CLASSNAME)}>
            <PlanUpgradeCard
              ...
              product={KEEL_COMMUNITY_PRODUCTS[EProductSubscriptionEnum.BUSINESS]}
          ...
          <div className={cn(COMMON_CARD_CLASSNAME)}>
            <PlanUpgradeCard
              ...
              product={KEEL_COMMUNITY_PRODUCTS[EProductSubscriptionEnum.ENTERPRISE]}
