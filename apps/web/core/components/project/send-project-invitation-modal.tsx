                    ...
                    render={({ field: { value, onChange } }) => {
                      ...
                      return (
                        <CustomSearchSelect
                          value={value}
                          customButton={
                            <button className="flex w-full items-center justify-between gap-1 rounded-md border border-subtle px-3 py-2 text-left text-13 text-secondary shadow-raised-100 duration-300 hover:bg-layer-1 hover:text-primary focus:outline-none">
                              {value && value !== "" ? (
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <CustomSelect
                          {...field}
                          customButton={
                            <div className="flex w-24 items-center justify-between gap-1 rounded-md border border-subtle px-3 py-2.5 text-left text-13 text-secondary shadow-raised-100 duration-300 hover:bg-layer-1 hover:text-primary focus:outline-none">
