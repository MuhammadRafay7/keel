...
import type { IUser, IWorkspace, TOnboardingSteps } from "@keel/types";
// ui
import { CustomSelect, Input, Spinner } from "@keel/ui";
import { validateWorkspaceName, validateSlug } from "@keel/utils";
// hooks
      ...
      {!!invitedWorkspaces && (
        <>
          ...
          >
            ...
            <span className="flex h-4 w-4 items-center justify-center rounded-xs bg-accent-primary/80 text-11 font-medium text-on-accent">
              {invitedWorkspaces}
            </span>
          </Button>
