...
export type TKeelPlans = "free" | "one" | "pro" | "business" | "enterprise";
...
type TPlanFeatureDetails = {
  ...
  cloud: Record<TKeelPlans, TPlanFeatureData>;
  "self-hosted"?: Record<TKeelPlans, TPlanFeatureData>;
};
...
type KeelPlans = {
  planDetails: Record<TKeelPlans, TPlanDetail>;
  planHighlights: Record<TKeelPlans, string[]>;
...
export function ComingSoonBadge({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "w-fit rounded-sm bg-accent-primary px-1.5 py-0.5 text-9 font-semibold whitespace-nowrap text-on-accent",
        className
      )}
    >
      COMING SOON
...
export const PLANS_LIST: TKeelPlans[] = ["free", "one", "pro", "business", "enterprise"];
...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout Keel without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          "Write Keel Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync Keel work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom Keel and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: "Get Keel activity in Slack and use / commands in\nSlack to make changes in Keel.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create Keel work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create Keel work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour Keel workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        ...
        description: "Secure your Keel workspace with device-\ndependent two-factor authentication and passkeys. ",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted Keel instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: "Install and deploy your self-hosted Keel to any\nprivate cloud with a single-line command.",
        cloud: {
          free: false,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <a
              href="https://keel.ostenmark.com/contact"
              target="_blank"
...
export const KEEL_PLANS: KeelPlans = {
  planDetails: {
    free: {
