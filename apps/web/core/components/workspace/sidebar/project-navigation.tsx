...
import type { EUserProjectRoles } from "@keel/types";
// keel ui
// components
...
export const ProjectNavigation = observer(function ProjectNavigation(props: TProjectItemsProps) {
  ...
  const baseNavigation = useCallback(
    (slug: string, forProjectId: string): TNavigationItem[] => [
      {
        i18n_key: "sidebar.work_items",
        key: "work_items",
        name: "Work items",
        href: `/${slug}/projects/${forProjectId}/issues`,
        icon: WorkItemsIcon,
      ...
      },
      {
        ...
        key: "cycles",
        name: "Cycles",
        href: `/${slug}/projects/${forProjectId}/cycles`,
        icon: CycleIcon,
      ...
      },
      {
        ...
        key: "modules",
        name: "Modules",
        href: `/${slug}/projects/${forProjectId}/modules`,
        icon: ModuleIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER],
      ...
      },
      {
        ...
        key: "views",
        name: "Views",
        href: `/${slug}/projects/${forProjectId}/views`,
        icon: ViewsIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
      ...
      },
      {
        ...
        key: "pages",
        name: "Pages",
        href: `/${slug}/projects/${forProjectId}/pages`,
        icon: PageIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
      ...
      },
      {
        ...
        key: "chat",
        name: "Chat",
        href: `/${slug}/projects/${forProjectId}/chat`,
        icon: MessagesSquare,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
        shouldRender: true,
        sortOrder: 6,
      },
      {
        ...
        key: "intake",
        name: "Intake",
        href: `/${slug}/projects/${forProjectId}/intake`,
        icon: IntakeIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
  ...
  const navigationItemsMemo = useMemo(() => {
    const navigationItems = (slug: string, forProjectId: string): TNavigationItem[] => {
      const navItems = baseNavigation(slug, forProjectId);

      if (additionalNavigationItems) {
        navItems.push(...additionalNavigationItems(slug, forProjectId));
      }
