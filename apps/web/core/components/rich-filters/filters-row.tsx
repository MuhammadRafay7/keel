...
import { cn, EHeaderVariant, Header, Loader } from "@keel/ui";
// local imports
...
export const FiltersRow = observer(function FiltersRow<K extends TFilterProperty, E extends TExternalFilter>(
  ...
  const mainContent = (
    <div className="flex w-full items-start gap-2 rounded-xl border border-subtle bg-surface-2/60 px-3.5 py-1.5 shadow-raised-100 backdrop-blur-md">
