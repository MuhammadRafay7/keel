      ...
      <div className="shell">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <Link href="/docs">Pages &amp; Wiki</Link>
              </li>
              <li>
                <Link href="/features">Keel AI</Link>
              </li>
              <li>
                <Link href="/features">Vercel &amp; Supabase</Link>
              </li>
            </ul>
            <h4 style={{ marginTop: "1.75rem" }}>Self-hosted</h4>
            <ul>
              <li>
                <Link href="/docs">AGPL Community</Link>
              </li>
              <li>
                <Link href="/docs">Self-Hosted Deployment</Link>
              </li>
              <li>
                <Link href="/docs">Supabase Edge Stack</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <Link href="/features">Work item relations</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/features">Modules &amp; Epics</Link>
              </li>
              <li>
                <Link href="/features">5 Layout Views</Link>
              </li>
              <li>
                <Link href="/features">Workspace Analytics</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <Link href="/about">Community Plan</Link>
              </li>
              <li>
                <Link href="/about">Pro Plan</Link>
              </li>
              <li>
                <Link href="/about">Enterprise</Link>
              </li>
            </ul>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <Link href="/about">Keel vs Jira</Link>
              </li>
              <li>
                <Link href="/about">Keel vs Linear</Link>
              </li>
              <li>
                <Link href="/about">Keel vs ClickUp</Link>
              </li>
              <li>
                <Link href="/about">Keel vs Monday</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <Link href="/changelog">The Keel Blog</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/docs">Architecture Spec</Link>
              </li>
            </ul>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <Link href="/contact">Switch to Keel</Link>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <div className="footer-apps">
            <a href={REPO} target="_blank" rel="noreferrer" className="footer-app-btn">
          ...
          <div className="footer-socials">
            <a href={REPO} target="_blank" rel="noreferrer" aria-label="GitHub" className="footer-social-link">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
