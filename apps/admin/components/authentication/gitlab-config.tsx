...
import type { TInstanceAuthenticationMethodKeys } from "@keel/types";
  ...
  return (
    <>
      {isGitlabConfigured ? (
        ...
        <Link href="/authentication/gitlab" className={getButtonStyling("secondary", "base")}>
          <Settings2 className="h-4 w-4 p-0.5" />
          Configure
        </Link>
      )}
    </>
